...
*   **Commit Messaging:** We strive for descriptive, conventional commit messages: `feat(api): ...`, `fix(ui): ...`, `docs: ...` identifying exactly what was altered in the commit subject. Autonomous agents **MUST** read the [Agent Commit Standards](doc/guides/agent-commit-standards.md) prior to dispatching any commit commands to ensure the Semantic Release action successfully builds the changelog.
