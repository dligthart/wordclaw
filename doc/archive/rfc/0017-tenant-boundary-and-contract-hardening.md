...
As of 2026-03-31, this RFC is partially implemented and its core hardening direction continues to shape the runtime on `main`.
...
- platform-versus-tenant supervisor scoping and admin-only tenant-onboarding hardening
...
- a safe domain decommission/delete lifecycle instead of direct SQL cleanup
