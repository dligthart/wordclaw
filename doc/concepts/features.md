...
WordClaw natively supports Retrieval-Augmented Generation (RAG) by embedding content directly into Postgres. For a detailed walkthrough of how this works and how agents can utilize it, read the [Native Vector RAG Guide](/doc/guides/native-vector-rag.md).
