<script lang="ts">
    ...
    let pageDescription = $derived(
        canOnboardTenants
            ? "Manage WordClaw access keys for agents and operators, and provision initial tenant admin access. External AI provider and workforce setup now lives under Agents."
    ...
    async function loadKeys() {
        ...
        try {
            ...
            error = err.message || "Failed to load access keys";
        } finally {
            loading = false;
        }
    }
