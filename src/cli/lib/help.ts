...
const USAGE_LINES = [
    ...
    'forms create --name <value> --slug <value> --content-type-id <n> [--description <value>] [--fields-json <json>|--fields-file <path>] [--default-data-json <json>|--default-data-file <path>] [--draft-generation-json <json>|--draft-generation-file <path>] [--active true|false] [--public-read true|false] [--submission-status <value>] [--workflow-transition-id <n>] [--require-payment true|false] [--webhook-url <value>] [--webhook-secret <value>] [--success-message <value>]',
    'forms update --id <n> [--name <value>] [--slug <value>] [--content-type-id <n>] [--fields-json <json>|--fields-file <path>] [--default-data-json <json>|--default-data-file <path>] [--draft-generation-json <json>|--draft-generation-file <path>|null] [--active true|false] [--public-read true|false] [--submission-status <value>] [--workflow-transition-id <n>|null] [--require-payment true|false] [--webhook-url <value>] [--webhook-secret <value>] [--success-message <value>]',
    'forms delete --id <n>',
    'forms submit --slug <value> --domain-id <n> [--data-json <json>|--data-file <path>]',
    'jobs list [--status queued|running|succeeded|failed|cancelled] [--kind content_status_transition|outbound_webhook|draft_generation] [--limit <n>] [--offset <n>]',
    'jobs get --id <n>',
    'jobs worker-status',
    'jobs create --kind content_status_transition|outbound_webhook|draft_generation [--payload-json <json>|--payload-file <path>] [--queue <value>] [--run-at <iso>] [--max-attempts <n>]',
    'jobs cancel --id <n>',
