...
const USAGE_LINES = [
    ...
    'content project --content-type-id <n> --group-by <value> [--status <value>] [--created-after <iso>] [--created-before <iso>] [--field-name <value>] [--field-op eq|contains|gte|lte] [--field-value <value>] [--metric count|sum|avg|min|max] [--metric-field <value>] [--order-by value|group] [--order-dir asc|desc] [--limit <n>]',
